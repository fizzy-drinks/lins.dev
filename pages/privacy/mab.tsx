...
const MABPrivacyPolicy: FC = () => {
  const seo = useSeo({
    uri: '/privacy/mab',
    title: 'Project MAB privacy policy',
    description: 'Project MAB privacy policy',
  });
  ...
  return (
    <main>
      ...
      <p>
        Gabriel Chiconi built Project MAB game as an Open Source game. This
        SERVICE is provided by Gabriel Chiconi at no cost and is intended for
        use as is.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Project MAB unless
      ...
      <p>
        ...
        hesitate to contact me at mab@lins.dev.
      </p>
    </main>
  );
};

export default MABPrivacyPolicy;
