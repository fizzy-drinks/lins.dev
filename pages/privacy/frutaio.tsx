...
const FrutaioPrivacyPolicy: FC = () => {
  const seo = useSeo({
    uri: '/privacy/frutaio',
    title: 'fruta.io privacy policy',
    description: 'fruta.io privacy policy',
  });
  ...
  return (
    <main>
      ...
      <p>
        Gabriel Chiconi built fruta.io game as an Open Source game. This
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at fruta.io unless
      ...
      <p>
        ...
        hesitate to contact me at frutaio@lins.dev.
      </p>
    </main>
  );
};

export default FrutaioPrivacyPolicy;
